# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2019-05-31 01:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('message', models.TextField(help_text='内容', verbose_name='内容')),
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='post_comment', to='article.Articles')),
            ],
        ),
    ]
